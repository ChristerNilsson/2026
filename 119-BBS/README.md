...
Filer
- `index.html` – enkel vy för att visa grupper och bordslistor.
...
Användning
- Bookmarklet: besök turneringssidan, klicka bookmarkleten. Den öppnar verktyget med filtrerade (avprickade) spelare.
- Direkt: öppna `index.html` lokalt eller via Pages och ange parametern `players` i formatet:
  `?turnering=Växjöspelen&n=8&players=1984 716556 Adam Nilsson|1954 12345 Bertil Svensson|...`

Parametrar
- `turnering` – turneringens namn.
- `n` – gruppstorlek (tillåtet: 4,6,8,10,12,14,16).
- `players` – pipe-separerad lista: `ELO [SSF] Namn`.

Exempel
`index.html?turnering=Växjöspelen&n=4&players=1984 716556 Adam Nilsson|1954 12345 Bertil Svensson`
